...
///
/// ```rust
/// use cortex_agent::llm::anthropic_custom::AnthropicApiError;
///
...
impl From<AnthropicApiError> for AdkError {
    fn from(err: AnthropicApiError) -> Self {
        ...
        let mut adk_err = AdkError::new(
            ErrorComponent::Model,
            category,
            "model.anthropic.api_error",
            msg,
        )
...
///
/// ```rust
/// use cortex_agent::llm::anthropic_custom::ConversionError;
///
