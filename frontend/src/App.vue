...
import { MessageCircle, Bot, Compass, Library, Cpu, Plug, Settings, Brain, Sparkles, Clock } from 'lucide-vue-next'
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/scheduled-tasks', icon: Clock, label: '定时任务', tooltip: '基于助手按周期自动执行，如每天出报表' },
