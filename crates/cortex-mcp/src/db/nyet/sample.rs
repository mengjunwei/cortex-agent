...
// crates/cortex-mcp/third-party/nyetdb/). Ported for cortex-mcp: stdio MCP
// tools instead of the nyet CLI; env-var config instead of config.toml.
...
mod tests {
    use super::*;
    use crate::db::nyet::validator::{self, DenyReason, Policy, Verdict};
